            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                emptyRows = function (parent, scroll, locdata) {
                    ...
                    if (scroll && ts.p.scroll) {
                        $(">div:first", parent).css({height: "auto"}).children("div:first").css({
                            height: 0,
                            display: "none"
                        });
                        parent.scrollTop = 0;
                ...
                addXmlData = function (xml, t, rcnt, more, adjust) {
                    ...
                    var i, fpos, ir = 0, v, row, gi = 0, si = 0, ni = 0, idn, getId, f = [], F, rd = {}, xmlr, rid,
                        rowData = [], cn = (ts.p.altRows === true) ? " " + ts.p.altclass : "", cn1;
                ...
                setColWidth = function () {
                    var initwidth = 0, brd = isSafari ? 0 : ts.p.cellLayout, vc = 0, lvc, scw = ts.p.scrollOffset, cw,
                        hs = false, aw, gw = 0,
                        cl = 0, cr;
    ...
    $.jgrid.extend({
        ...
        setGridWidth: function (nwidth, shrink) {
            return this.each(function () {
                ...
                var $t = this, cw,
                    initwidth = 0, brd = $.browser.webkit || $.browser.safari ? 0 : $t.p.cellLayout, lvc, vc = 0,
                    hs = false, scw = $t.p.scrollOffset, aw, gw = 0,
                    cl = 0, cr;
