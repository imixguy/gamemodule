...
<div id="waitGwin"
     style="position:absolute;z-index:1000;left:0;top:0; background:black; height:1000px;opacity: 0.8;width: 100%;">
    <div style="color: white;font-size: 40pt;margin: 0 auto;padding: 300px;text-align: center;width: 500px;">Ожидание
        игроков!!
    </div>
</div>
...
//        this.migEl.attr('src','/resources/images/games/'+this.room.imageFolder+'/ramka.gif');
        ...
        buildSystemControl: function () {
            ...
            $('#centerPl').append($('<div id="systContr" style="position:absolute;left: 0;top:0; z-index: 10; width: ' + this.actSize.shCPl + 'px;height:' + this.actSize.shCPl + 'px;">').append(topPanel).append(bottomPanel));
        },
